...
class HybridModel:
    ...
    def _get_model_mf_old(self, n_factors=20, include_bias=False):
        lmdba = 0.00001
    ...
    def _get_model_mf(self, n_factors):
        ...
        vec_implicit = Embedding(self.n_users, self.n_items, input_length=1, trainable=False)(input_u)
    ...
    def _get_model_ann(self, meta_users, meta_items, include_bias=True):
        lmdba = 0.00001
        regularizer = keras.regularizers.l2(lmdba)
    ...
    def _recompute_implicit(self, inds_u, inds_i, y):
        ...
        self.model_mf.layers[1].set_weights([implicit_norm])
    ...
    def train_initial(self, inds_u_train, inds_i_train, y_train, prnt=False):
        ...
        self._recompute_implicit(inds_u_train, inds_i_train, y_train)
        ...
        history = self.model_mf.fit([inds_u_train, inds_i_train], y_train, batch_size=batch_size, epochs=200,
